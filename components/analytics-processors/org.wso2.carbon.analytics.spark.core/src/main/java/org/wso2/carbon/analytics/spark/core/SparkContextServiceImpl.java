...
/**
 * This class exposes the initialized JavaSparkContext as a service. This is exposed as OSGI service for other carbon
 * components to consume and invoke the operations necessarily.
 */
